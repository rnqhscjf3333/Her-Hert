...
public class NetworkManager1 : MonoBehaviourPunCallbacks
{
    ...
    void Update()
    {
        ...
        if (RoomPanel.activeSelf==true && Input.GetKeyDown(KeyCode.Return))
        {
            Send();
        }
    }
    ...
    #region 방
    public void CreateRoom() => PhotonNetwork.CreateRoom(RoomInput.text == "" ? "Room" + Random.Range(0, 100) : RoomInput.text, new RoomOptions { MaxPlayers = 6 });
